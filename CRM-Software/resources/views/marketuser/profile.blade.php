													...
													<ul class="profile-edit-list row">
														<li class="weight-900 col-md-9">
															...
															<div class="form-group">
																...
																<input class="form-control form-control-lg" type="text" name="username" value="{{$name}}" required>
															</div>
															<div class="form-group">
																<label>Email</label>
															...
															<div class="form-group">
																<label>Gender</label>
																<input class="form-control form-control-lg" type="text" name="gender" value="{{$gender}}" required>
															</div>
